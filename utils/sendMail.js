...
exports.sendEmail = async options => {
  const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'rahit.avsom@gmail.com',
      pass: 'fokfdwwwlyalezcv',
    },
  });

  const mailOptions = {
    from: 'chousin Rahit <rahit.avsom@gmail.com>',
    to: options.email,
                    ...
                    <tr>
                      <td style="padding: 0 35px">
                        ...
                        <p
                          ...
                          "
                        >
                          If the above button does not work for you, copy and
                          paste the following into your browsers address bar:
                        </p>
                        ${options.resetUrl}
                      </td>
                    </tr>
              ...
              <tr>
                <td style="text-align: center">
                  <p
                    ...
                    "
                  >
                    &copy; <strong>Mana Project</strong>
                  </p>
                </td>
              </tr>
              <tr>
